...
public class JitsiMeetOngoingConferenceService  extends Service implements OngoingConferenceTracker.OngoingConferenceListener {
    ...
    private final JitsiMeetOngoingConferenceService.BroadcastReceiver broadcastReceiver = new JitsiMeetOngoingConferenceService.BroadcastReceiver((SyntheticClass_1)null);
